...
<?php echo form_open_multipart($prds['pid'],'class=form-horizontal id=form-control') ?>
<div class="form-control">
	...
	<ul class="ul_cont">
		...
		<li><input type="text" name="chck" class="form-control required" /><?php echo form_error('chck');?></li>
